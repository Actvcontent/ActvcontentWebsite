...
(function($) {
  ...
  window.mc = {
    ...
    getGroups: function (){ 
      var groups = {};
      $(".modal-email__field-group").each(function(index) {
    ...
    isMultiPartField: function(element) {
      return ($('input:not(:hidden)' , $(element).closest(".modal-email__field-group")).length > 1);
    },
    /**
    ...
    isTooEarly: function(element) {
      var fields = $('input:not(:hidden)' , $(element).closest(".modal-email__field-group"));
    ...
    mce_success_cb: function(resp){
      // console.log(resp);
        ...
        $('.modal-email__response-success').hide();
        $('.modal-email__response-error').hide();

        // On successful form submission, display a success message and reset the form
        if (resp.result == "success"){
            // Show the form
            $('.modal-email__response-success').show();
            
            // msg
            $('#mce-'+resp.result+'-response').html(resp.msg);
            
            modal.$.modalInner.classList.add('modal-video');
          ...
          $('.modal-email__response-error').html("Please enter an email").show();
          $('#mce-EMAIL').focus();
